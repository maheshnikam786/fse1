...
public class MovieServiceTest {
    ...
    void findSeats() {
        ...
        tickets.add(new Ticket("Ram","The Matrix", "Screen 1", 2, Arrays.asList("a1,a2")));
    ...
    @Test
    void testSaveTicket() {
        Ticket expectedTicket = new Ticket("Ram","The Matrix", "Screen 1", 2,  Arrays.asList("a1,a2"));
    ...
    void testGetAllBookedTickets() {
        ...
        List<Ticket> expectedTickets = Arrays.asList(
                new Ticket("Ram","The Matrix", "Screen 1", 2,  Arrays.asList("a1,a2")));
